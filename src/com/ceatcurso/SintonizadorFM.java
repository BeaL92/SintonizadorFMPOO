...
public class SintonizadorFM {
	...
	public SintonizadorFM(double frecuencia) {//debo validar una frecuencia válida
		if (frecuencia<80) {
			this.frecuencia=80;
	...
	// la opcion favorito le pasa el valor de la fecuendia y sobescreibe cualquir valor anterios que tenga
	...
	public double down() {
		this.frecuencia-=0.5;//bajamos la frecuencia en 0.5 MHz
	...
	public double up() {
		this.frecuencia+=0.5;//subimos la frecuencia en 0.5 MHz
		//debo comprobar que la frecuencia este entre 80 y 108 MHZ
		comprobarFrecuencia();
		return this.frecuencia;
